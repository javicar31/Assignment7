...
/********************************************************************* 
 *  Program: GamesTable2_JC.java                                     *
 *  Author:  Javier Carnicer                                         * 
 *  Purpose: take two .txt files and output a table UPDATED          *
...
public class GamesTable2_JC {
    public static void main(String[] args) throws IOException {
        // Reading and storing games.txt
        String[][] gamesArray = new String[22][3];
        ...
        String[][] teamsArray = new String[22][1];
